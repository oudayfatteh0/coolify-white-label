...
<x-slot:title>
    Onboarding | {{ branding()->productName() }}
    </x-slot>
        ...
        <div class="flex flex-col items-center w-full space-y-8">
            @if ($currentState === 'welcome')
                <div class="w-full max-w-2xl text-center space-y-8">
                    <div class="space-y-4">
                        <h1 class="text-4xl font-bold lg:text-6xl">Welcome to {{ branding()->productName() }}</h1>
            ...
            @elseif ($currentState === 'explanation')
                ...
                <x-boarding-step title="Platform Overview">
                    <x-slot:question>
                        {{ branding()->productName() }} automates deployment and infrastructure management on your own servers. Deploy applications
                        from Git, manage databases, and monitor everything—without vendor lock-in.
                    </x-slot:question>
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Automation:" /> {{ branding()->productName() }} handles server configuration, Docker management,
                            and
            ...
            @elseif ($currentState === 'select-server-type')
                ...
                <x-boarding-step title="Choose Server Type">
                                ...
                                <div class="flex flex-col gap-4 text-left">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm dark:text-neutral-400">
                                            Deploy on the server running {{ branding()->productName() }}. Best for testing and single-server setups.
                                        </p>
                                    </div>
                                </div>
                            </button>
                            ...
                            <div class="mt-6 p-4 border border-error rounded-lg text-gray-800 dark:text-gray-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <ul class="list-disc list-inside">
                                        ...
                                        <li>Or skip the boarding process and manually add a new private key to {{ branding()->productName() }} and
                                            the server</li>
                                    </ul>
                                </div>
                    ...
                    <x-slot:explanation>
                        ...
                        <p>
                            <x-highlighted text="Localhost:" /> The machine running {{ branding()->productName() }}. Not recommended for production
            ...
            @elseif ($currentState === 'private-key')
                ...
                <x-boarding-step title="SSH Authentication">
                    ...
                    <x-slot:explanation>
                        ...
                        <p>
                            <x-highlighted text="Key Generation:" /> {{ branding()->productName() }} generates ED25519 keys by default for optimal
            ...
            @elseif ($currentState === 'create-private-key')
                ...
                <x-boarding-step title="SSH Key Configuration">
                    ...
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Key Storage:" /> Private keys are encrypted at rest in {{ branding()->productName() }}'s database.
                        </p>
                        <p>
            ...
            @elseif ($currentState === 'validate-server')
                ...
                <x-boarding-step title="Server Validation">
                    <x-slot:question>
                        {{ branding()->productName() }} will automatically install Docker {{ $minDockerVersion }}+ if not present.
                    </x-slot:question>
                    <x-slot:actions>
                    ...
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Automated Setup:" /> {{ branding()->productName() }} installs Docker Engine, Docker Compose, and
